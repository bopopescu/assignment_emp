...
options:
  ...
  access_level:
    description:
      ...
      - reporter
      - developer
      - main (alias for maintainer)
      - maintainer
      - owner
    default: guest
    type: str
    choices: ["guest", "reporter", "developer", "main", "maintainer", "owner"]
  state:
    description:
...
def main():
    ...
    argument_spec.update(dict(
        ...
        group=dict(type='str'),
        access_level=dict(type='str', default="guest", choices=["developer", "guest", "maintainer", "main", "owner", "reporter"]),
