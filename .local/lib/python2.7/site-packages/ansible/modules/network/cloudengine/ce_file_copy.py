    ...
    file_system:
        description:
            - The remote file system of the device. If omitted,
              ...
              1) C(flash) is root directory of the flash memory on the main MPU.
              2) C(subordinate#flash) is root directory of the flash memory on the subordinate MPU.
                 If no subordinate MPU exists, this drive is unavailable.
