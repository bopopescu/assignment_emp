...
class Interfaces(object):
    ...
    def get_phy_main_subordinate_mode(self):
        return self.api.Networking.Interfaces.get_phy_main_subordinate_mode(self.interfaces)
...
def generate_interface_dict(f5, regex):
    ...
    fields = ['active_media', 'actual_flow_control', 'bundle_state',
              ...
              'phy_main_subordinate_mode', 'prefer_sfp_state', 'flow_control',
