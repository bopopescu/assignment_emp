...
options:
  ...
  speed:
    ...
    choices: ['10-full', '10-half', '100-full', '100-half', '1000-full', '1000-full-main',
    '1000-full-subordinate', '10g-full', '10g-full-main', '10g-full-subordinate', '2500-full', '2500-full-main',
    '2500-full-subordinate', '5g-full', '5g-full-main', '5g-full-subordinate', 'auto']
    type: str
  stp:
    description:
...
def main():
    ...
    element_spec = dict(
        ...
        speed=dict(type='str', choices=['10-full', '10-half', '100-full', '100-half', '1000-full', '1000-full-main',
                                        '1000-full-subordinate', '10g-full', '10g-full-main', '10g-full-subordinate', '2500-full', '2500-full-main',
                                        '2500-full-subordinate', '5g-full', '5g-full-main', '5g-full-subordinate', 'auto']),
        stp=dict(type='bool'),
        tx_rate=dict(),
