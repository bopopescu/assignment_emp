...
options:
    ...
    system_dns_database:
        ...
        suboptions:
            ...
            ip_main:
                description:
                    - IP address of main DNS server. Entries in this main DNS server and imported into the DNS zone.
                type: str
            name:
                description:
                    - Zone name.
            ...
            type:
                description:
                    - Zone type (main to manage entries directly, subordinate to import entries from other zones).
                type: str
                choices:
                    - main
                    - subordinate
    ...
    fields = {
        ...
        "system_dns_database": {
            ...
            "options": {
                ...
                "ip_main": {"required": False, "type": "str"},
