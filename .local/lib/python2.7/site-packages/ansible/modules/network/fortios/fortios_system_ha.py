...
options:
    ...
    system_ha:
        ...
        suboptions:
            ...
            multicast_ttl:
                description:
                    - HA multicast TTL on main (5 - 3600 sec).
                type: int
            ...
            override:
                description:
                    - Enable and increase the priority of the unit that should always be primary (main).
                type: str
                choices:
                    - enable
                    - disable
            ...
            pingserver_monitor_interface:
                ...
                type: str
            pingserver_subordinate_force_reset:
                description:
  ...
  - name: Configure HA.
    fortios_system_ha:
      ...
      system_ha:
        ...
        pingserver_subordinate_force_reset: "enable"
...
http_status:
  ...
  sample: "200"
mkey:
  description: Main key (id) used in the last call to FortiGate
  returned: success
  type: str
  sample: "id"
name:
...
def filter_system_ha_data(json):
    option_list = ['arps', 'arps_interval', 'authentication',
                   ...
                   'pingserver_flip_timeout', 'pingserver_monitor_interface', 'pingserver_subordinate_force_reset',
    ...
    fields = {
        ...
        "system_ha": {
            ...
            "options": {
                ...
                "pingserver_subordinate_force_reset": {"required": False, "type": "str",
                                                 "choices": ["enable", "disable"]},
