...
options:
    ...
    user_device:
        ...
        suboptions:
            ...
            main_device:
                description:
                    - Main device (optional). Source user.device.alias.
                type: str
            tagging:
                description:
  ...
  - name: Configure devices.
    fortios_user_device:
      ...
      user_device:
        ...
        comment: "Comment."
        mac: "<your_own_value>"
        main_device: "<your_own_value> (source user.device.alias)"
        tagging:
         -
    ...
    fields = {
        ...
        "user_device": {
            ...
            "options": {
                ...
                "main_device": {"required": False, "type": "str"},
