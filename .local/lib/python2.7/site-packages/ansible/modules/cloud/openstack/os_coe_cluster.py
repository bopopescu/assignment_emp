...
options:
   ...
   main_count:
      description:
         - The number of main nodes for this cluster
      default: 1
   name:
      description:
...
def main():
    argument_spec = openstack_full_argument_spec(
        ...
        main_count=dict(type='int', default=1),
        main_flavor_id=dict(default=None),
    ...
    kwargs = dict(
        ...
        main_count=module.params['main_count'],
        main_flavor_id=module.params['main_flavor_id'],
