...
options:
  # General module options
    ...
    force_update_password:
        description:
          - Set to True to update your cluster password with I(main_user_password). Since comparing passwords to determine
    ...
    apply_immediately:
        description:
          - A value that specifies whether modifying a cluster with I(new_db_instance_identifier) and I(main_user_password)
    ...
    main_user_password:
        description:
          - An 8-41 character password for the main database user. The password can contain any printable ASCII character
    ...
    main_username:
        description:
          - The name of the main user for the DB cluster. Must be 1-16 letters or numbers and begin with a letter.
        aliases:
          - username
        type: str
...
main_username:
  description: The main username for the DB instance.
  returned: always
  type: str
  sample: test
max_allocated_storage:
...
def get_options_with_changing_values(client, module, parameters):
    ...
    if not force_update_password:
        parameters.pop('MainUserPassword', None)
...
def main():
    ...
    parameter_options = dict(
        ...
        kms_key_id=dict(),
        license_model=dict(),
        main_user_password=dict(aliases=['password'], no_log=True),
        main_username=dict(aliases=['username']),
    ...
    required_if = [
        ...
        ('creation_source', 's3', (
            's3_bucket_name', 'engine', 'main_username', 'main_user_password',
