...
options:
  ...
  username:
    description:
      - Main database username. Used only when command=create.
  password:
    description:
      - Password for the main database username. Used only when command=create or command=modify.
  region:
    description:
        ...
        pending_modified_values:
            ...
            contains:
                ...
                iops:
                    ...
                    sample: "null"
                main_user_password:
                    description: the pending or in-progress change of the main credentials for this RDS instance
                    returned: when RDS instance exists
                    type: str
                    sample: "null"
                multi_az:
...
class RDSDBInstance:
    ...
    def get_data(self):
        d = {
            ...
            'username': self.instance.main_username,
...
class RDS2DBInstance:
    ...
    def get_data(self):
        d = {
            ...
            'username': self.instance['MainUsername'],
        ...
        if self.instance['PendingModifiedValues'] is not None:
            ...
            d['pending_modified_values'] = {
                ...
                'main_user_password': pdv['MainUserPassword'],
                'port': pdv['Port'],
                'iops': pdv['Iops'],
