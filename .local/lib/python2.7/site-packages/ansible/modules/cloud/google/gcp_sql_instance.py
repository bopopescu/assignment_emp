...
options:
  ...
  instance_type:
    ...
    - "* CLOUD_SQL_INSTANCE: A Cloud SQL instance that is not replicating from a main."
  ...
  main_instance_name:
    description:
    - The name of the instance which will act as main in the replication setup.
    required: false
    type: str
  max_disk_size:
    description:
  ...
  replica_configuration:
    ...
    suboptions:
      failover_target:
        ...
        - In case the main instance fails, the replica instance will be promoted
          as the new main instance.
        - Only one replica can be specified as failover target, and the replica has
          to be in different zone with the main instance.
        required: false
        type: bool
      mysql_replica_configuration:
        description:
        - MySQL specific configuration when replicating from a MySQL on-premises main.
          ...
          in a file named main.info in the data directory.
        required: false
        type: dict
        suboptions:
          ca_certificate:
          ...
          client_certificate:
            description:
            - PEM representation of the subordinate's x509 certificate .
            required: false
            type: str
          client_key:
            description:
            - PEM representation of the subordinate's private key. The corresponding public
          ...
          dump_file_path:
            description:
            - Path to a SQL dump file in Google Cloud Storage from which the subordinate
              ...
              accomplished by setting --main-data to 1 when using mysqldump.
            required: false
            type: str
          ...
          verify_server_certificate:
            description:
            - Whether or not to check the main's Common Name value in the certificate
  ...
  contains:
    available:
      ...
      - The availability status of the failover replica. A false status indicates
        that the failover replica is out of sync. The main can only failover to
...
replicaConfiguration:
  ...
  contains:
    failoverTarget:
      ...
      - In case the main instance fails, the replica instance will be promoted as
        the new main instance.
      - Only one replica can be specified as failover target, and the replica has
        to be in different zone with the main instance.
      returned: success
      type: bool
    mysqlReplicaConfiguration:
      ...
      - MySQL specific configuration when replicating from a MySQL on-premises main.
        ...
        a file named main.info in the data directory.
      returned: success
      type: complex
      contains:
        caCertificate:
        ...
        dumpFilePath:
          description:
          - Path to a SQL dump file in Google Cloud Storage from which the subordinate instance
            ...
            --main-data to 1 when using mysqldump.
          returned: success
          type: str
        mainHeartbeatPeriod:
          description:
...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(
            ...
            main_instance_name=dict(type='str'),
                ...
                options=dict(
                    ...
                    mysql_replica_configuration=dict(
                        ...
                        options=dict(
                            ...
                            main_heartbeat_period=dict(type='int'),
...
def resource_to_request(module):
    request = {
        ...
        u'mainInstanceName': module.params.get('main_instance_name'),
...
def response_to_hash(module, response):
    return {
        ...
        u'mainInstanceName': response.get(u'mainInstanceName'),
        ...
        return remove_nones_from_dict(
            {
                ...
                u'mainHeartbeatPeriod': self.request.get('main_heartbeat_period'),
        ...
        return remove_nones_from_dict(
            {
                ...
                u'mainHeartbeatPeriod': self.request.get(u'mainHeartbeatPeriod'),
