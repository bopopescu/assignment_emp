...
resources:
  ...
  contains:
      ...
      contains:
        ...
        password:
          ...
          - The password to use for HTTP basic authentication to the main endpoint.
            Because the main endpoint is open to the Internet, you should create
      ...
      contains:
        enablePrivateNodes:
          ...
          - Whether nodes have internal IP addresses only. If enabled, all nodes are
            given only RFC 1918 private addresses and communicate with the main
      ...
      contains:
        ...
        networkPolicyConfig:
          ...
          - Configuration for NetworkPolicy. This only tracks whether the addon is
            enabled or not on the Main, it does not track whether network policy
    ...
    initialClusterVersion:
      description:
      - The software version of the main endpoint and kubelets used in the cluster
