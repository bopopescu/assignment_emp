    ...
    suboptions:
      enable_private_nodes:
        ...
        - Whether nodes have internal IP addresses only. If enabled, all nodes are
          given only RFC 1918 private addresses and communicate with the main via
          private networking.
        required: false
        type: bool
      enable_private_endpoint:
        description:
        - Whether the main's internal IP address is used as the cluster endpoint.
        required: false
        type: bool
      main_ipv4_cidr_block:
        description:
        - The IP range in CIDR notation to use for the hosted main network. This
          range will be used for assigning internal IP addresses to the main or
          set of mains, as well as the ILB VIP. This range must not overlap with
    ...
    suboptions:
      ...
      network_policy_config:
        ...
        - Configuration for NetworkPolicy. This only tracks whether the addon is enabled
          or not on the Main, it does not track whether network policy is enabled
          for the nodes.
        required: false
        type: dict
        version_added: 2.9
...
mainAuth:
  ...
  contains:
    ...
    password:
      description:
      - The password to use for HTTP basic authentication to the main endpoint.
        Because the main endpoint is open to the Internet, you should create a strong
  ...
  contains:
    enablePrivateNodes:
      ...
      - Whether nodes have internal IP addresses only. If enabled, all nodes are given
        only RFC 1918 private addresses and communicate with the main via private
        networking.
      returned: success
      type: bool
    ...
    mainIpv4CidrBlock:
      description:
      - The IP range in CIDR notation to use for the hosted main network. This range
        will be used for assigning internal IP addresses to the main or set of mains,
    ...
    privateEndpoint:
      description:
      - The internal IP address of this cluster's main endpoint.
      returned: success
      type: str
    publicEndpoint:
      description:
      - The external IP address of this cluster's main endpoint.
      returned: success
      type: str
clusterIpv4Cidr:
  description:
...
endpoint:
  description:
  - The IP address of this cluster's main endpoint.
  - The endpoint can be accessed from the internet at https://username:password@endpoint/
    See the mainAuth property of this resource for username and password information.
  returned: success
  type: str
initialClusterVersion:
  description:
  - The software version of the main endpoint and kubelets used in the cluster when
    it was first created. The version can be upgraded over time.
  returned: success
  type: str
currentMainVersion:
  description:
  - The current software version of the main endpoint.
  returned: success
  type: str
currentNodeVersion:
  description:
    ...
    module = GcpModule(
        argument_spec=dict(
            ...
            private_cluster_config=dict(
                type='dict',
                options=dict(enable_private_nodes=dict(type='bool'), enable_private_endpoint=dict(type='bool'), main_ipv4_cidr_block=dict(type='str')),
            ),
...
def resource_to_request(module):
    request = {
        ...
        u'mainAuth': ClusterMainauth(module.params.get('main_auth', {}), module).to_request(),
...
def response_to_hash(module, response):
    return {
        ...
        u'initialNodeCount': module.params.get('initial_node_count'),
        u'nodeConfig': ClusterNodeconfig(module.params.get('node_config', {}), module).to_request(),
        u'mainAuth': ClusterMainauth(response.get(u'mainAuth', {}), module).from_response(),
        ...
        u'currentMainVersion': response.get(u'currentMainVersion'),
...
class Kubectl(object):
    ...
    def _contents(self):
        ...
        return {
            'apiVersion': 'v1',
            'clusters': [
                {'name': context, 'cluster': {'certificate-authority-data': str(self.fetch['mainAuth']['clusterCaCertificate']), 'server': endpoint}}
            ],
            ...
            'users': [
                {
                    ...
                    'user': {
                        ...
                        'username': str(self.fetch['mainAuth']['username']),
                        'password': str(self.fetch['mainAuth']['password']),
                    },
                }
            ],
        }
        ...
        return remove_nones_from_dict(
            {
                ...
                u'mainIpv4CidrBlock': self.request.get('main_ipv4_cidr_block'),
            }
        )
        ...
        return remove_nones_from_dict(
            {
                ...
                u'mainIpv4CidrBlock': self.request.get(u'mainIpv4CidrBlock'),
            }
        )
