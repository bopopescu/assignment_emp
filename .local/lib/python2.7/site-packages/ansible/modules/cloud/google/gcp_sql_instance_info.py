      ...
      contains:
        available:
          ...
          - The availability status of the failover replica. A false status indicates
            that the failover replica is out of sync. The main can only failover
      ...
      contains:
        failoverTarget:
          ...
          - Only one replica can be specified as failover target, and the replica
            has to be in different zone with the main instance.
          returned: success
          type: bool
        mysqlReplicaConfiguration:
          description:
          - MySQL specific configuration when replicating from a MySQL on-premises
            main. Replication configuration information such as the username, password,
            ...
            by MySQL in a file named main.info in the data directory.
          returned: success
          type: complex
          contains:
            caCertificate:
            ...
            dumpFilePath:
              ...
              - Path to a SQL dump file in Google Cloud Storage from which the subordinate
                ...
                be accomplished by setting --main-data to 1 when using mysqldump.
              returned: success
              type: str
            mainHeartbeatPeriod:
              description:
