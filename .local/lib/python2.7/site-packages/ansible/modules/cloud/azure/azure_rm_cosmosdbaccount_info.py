...
accounts:
    ...
    contains:
        ...
        secondary_main_key:
            ...
            type: str
            sample: UIWoYD4YaD4LxW6k3Jy69qcHDMLX4aSttECQkEcwWF1RflLd6crWSGJs0R9kJwujehtfLGeQx4ISVSJfTpJkYw==
        primary_readonly_main_key:
            description:
                - Primary main key.
            returned: when requested
            type: str
            sample: UIWoYD4YaD4LxW6k3Jy69qcHDMLX4aSttECQkEcwWF1RflLd6crWSGJs0R9kJwujehtfLGeQx4ISVSJfTpJkYw==
        secondary_readonly_main_key:
            description:
                - Primary main key.
            returned: when requested
            type: str
    ...
    def format_response(self, item):
        ...
        if self.retrieve_keys == 'all':
            keys = self.mgmt_client.database_accounts.list_keys(resource_group_name=self.resource_group,
                                                                account_name=self.name)
            d['primary_main_key'] = keys.primary_main_key
            d['secondary_main_key'] = keys.secondary_main_key
            d['primary_readonly_main_key'] = keys.primary_readonly_main_key
            d['secondary_readonly_main_key'] = keys.secondary_readonly_main_key
