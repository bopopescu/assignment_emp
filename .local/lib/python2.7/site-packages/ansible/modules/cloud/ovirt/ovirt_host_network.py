    ...
    def has_update(self, nic_service):
        ...
        if bond:
            ...
            update = update or not equal(
                ...
                sorted(get_link_name(self._connection, s) for s in nic.bonding.subordinates)
            )
        ...
        if (
            ...
            if nic is not None:
                for host_nic in nics_service.list():
                    if host_nic.bonding and nic.id in [subordinate.id for subordinate in host_nic.bonding.subordinates]:
